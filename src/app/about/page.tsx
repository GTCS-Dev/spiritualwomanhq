  ...
  return (
    ...
    >
      <div className="grid gap-8">
        {/* ── Welcome / Overview ── */}
        <section className="relative overflow-hidden rounded-2xl border border-[#E19508]/15 bg-white">
          ...
          <div className="relative z-10 grid gap-0 md:grid-cols-2">
            <div className="px-6 py-8 sm:px-10">
              <h2 className="text-2xl font-bold text-[#001946]">Empowering Women to Grow in Faith and Purpose</h2>
              <p className="mt-4 text-sm leading-7 text-[#5d6068]">
              ...
              <p className="mt-3 text-sm leading-7 text-[#5d6068]">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <article className="relative overflow-hidden rounded-2xl border-2 border-[#E19508]/15 bg-white px-6 py-6 shadow-[0_28px_60px_-30px_rgba(0,25,70,0.2)]">
            ...
            <div className="relative z-10">
              ...
              <h2 className="mt-4 text-2xl font-bold text-[#001946]">Vision</h2>
              <p className="mt-3 text-sm leading-7 text-[#5d6068]">
          ...
          <article className="relative overflow-hidden rounded-2xl border-2 border-[#E19508]/15 bg-white px-6 py-6 shadow-[0_28px_60px_-30px_rgba(0,25,70,0.2)]">
            ...
            <div className="relative z-10">
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#E19508]/12 text-lg">✦</span>
              <h2 className="mt-4 text-2xl font-bold text-[#001946]">Culture</h2>
              <p className="mt-3 text-sm leading-7 text-[#5d6068]">
        ...
        {/* ── What We Offer ── */}
        <section className="relative overflow-hidden rounded-2xl border-2 border-[#E19508]/15 bg-white px-6 py-8 sm:px-10 shadow-[0_28px_60px_-30px_rgba(0,25,70,0.2)]">
          <div className="pointer-events-none absolute -right-16 -top-16 h-52 w-52 rounded-full border-2 border-[#E19508]/8" />
          <div className="relative z-10">
            <h2 className="text-2xl font-bold text-[#001946]">What We Offer</h2>
            <div className="mt-5 grid gap-5 md:grid-cols-3">
              <div className="rounded-xl bg-[#fef6f0] px-5 py-5 border border-[#E19508]/10">
                <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-[#980140]">Women&rsquo;s Fellowship</h3>
                <p className="mt-2 text-sm leading-7 text-[#5d6068]">
              ...
              <div className="rounded-xl bg-[#fef6f0] px-5 py-5 border border-[#E19508]/10">
                <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-[#980140]">Sunday Messages</h3>
                <p className="mt-2 text-sm leading-7 text-[#5d6068]">
              ...
              <div className="rounded-xl bg-[#fef6f0] px-5 py-5 border border-[#E19508]/10">
                <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-[#980140]">Events & Retreats</h3>
                <p className="mt-2 text-sm leading-7 text-[#5d6068]">
